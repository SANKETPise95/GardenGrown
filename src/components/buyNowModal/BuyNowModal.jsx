                ...
                <DialogBody className="">
                    ...
                    <div className="mb-3">
                        <input
                            ...
                            className='bg-green-50 border border-green-200 px-2 py-2 w-full rounded-md outline-none text-green-600 text-green-600 placeholder-green-300'
                        />
                    </div>
                    ...
                    <div className="mb-3">
                        <input
                            ...
                            className='bg-green-50 border border-pink-200 px-2 py-2 w-full rounded-md outline-none text-pink-600 placeholder-pink-300'
                        />
                    </div>
